...
function FirstPage() {
  return (
    <>
      <br />
      <h1 className="text-3xl font-medium text-cyan-600 flex justify-center">
        FirstPage ga xush kelibsiz!
      </h1>
      <br />
      ...
      <h3>
      <Link to={'/navbar'} className="text-2xl text-blue-700">Ortga qaytish</Link>
      </h3>
    </>
  );
}
